...
public class Wednesday extends AppCompatActivity {
    ...
    private EditText editTextText110, editTextText111, editTextText112, editTextText113, editTextText114, editTextText115, editTextText116, editTextText117;
    ...
    private Button button44, button45;
    ...
    public void onClickSave() {
        ...
        edit.putString("key_text110", editTextText110.getText().toString());
        edit.putString("key_text111", editTextText111.getText().toString());
        edit.putString("key_text112", editTextText112.getText().toString());
        edit.putString("key_text113", editTextText113.getText().toString());
        edit.putString("key_text114", editTextText114.getText().toString());
        edit.putString("key_text115", editTextText115.getText().toString());
        edit.putString("key_text116", editTextText116.getText().toString());
        edit.putString("key_text117", editTextText117.getText().toString());
    ...
    public void onClickGet() {
        editTextText110.setText(pref.getString("key_text110", ""));
        editTextText111.setText(pref.getString("key_text111", ""));
        editTextText112.setText(pref.getString("key_text112", ""));
        editTextText113.setText(pref.getString("key_text113", ""));
        editTextText114.setText(pref.getString("key_text114", ""));
        editTextText115.setText(pref.getString("key_text115", ""));
        editTextText116.setText(pref.getString("key_text116", ""));
        editTextText117.setText(pref.getString("key_text117", ""));
    ...
    public void clearData (View v) {
        ...
        SharedPreferences.Editor edit = pref.edit();
        String[] textKeys = {
                "key_text110", "key_text112", "key_text113",
                "key_text111", "key_text114", "key_text115",
                "key_text116", "key_text117"
        };
        ...
        if (success) {
            editTextText110.setText("");
            editTextText111.setText("");
            editTextText112.setText("");
            editTextText113.setText("");
            editTextText114.setText("");
            editTextText115.setText("");
            editTextText116.setText("");
            editTextText117.setText("");
        }
    }
}
